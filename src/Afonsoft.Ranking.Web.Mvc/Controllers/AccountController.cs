...
using Afonsoft.Ranking.Authentication.TwoFactor.Google;
using Afonsoft.Ranking.Authorization;
using Afonsoft.Ranking.Authorization.Accounts;
using Afonsoft.Ranking.Authorization.Accounts.Dto;
using Afonsoft.Ranking.Authorization.Delegation;
using Afonsoft.Ranking.Authorization.Impersonation;
...
using Afonsoft.Ranking.Net.Sms;
using Afonsoft.Ranking.Notifications;
using Afonsoft.Ranking.Web.Models.Account;
using Afonsoft.Ranking.Security;
using Afonsoft.Ranking.Security.Recaptcha;
using Afonsoft.Ranking.Sessions;
using Afonsoft.Ranking.Url;
using Afonsoft.Ranking.Web.Authentication.External;
using Afonsoft.Ranking.Web.Security.Recaptcha;
using Afonsoft.Ranking.Web.Session;
using Afonsoft.Ranking.Web.Views.Shared.Components.TenantChange;

namespace Afonsoft.Ranking.Web.Controllers
{
    public class AccountController : RankingControllerBase
    {
