...
!function(e){e(["jquery"],function(e){return function(){var t=window.abp||{};t.appPath=t.appPath||"/",t.pageLoadTime=new Date,t.toAbsAppPath=function(e){return 0==e.indexOf("/")&&(e=e.substring(1)),t.appPath+e},t.multiTenancy=t.multiTenancy||{},t.multiTenancy.isEnabled=!1,t.multiTenancy.ignoreFeatureCheckForHostUsers=!1,t.multiTenancy.sides={TENANT:1,HOST:2},t.multiTenancy.tenantIdCookieName="Abp.TenantId",t.multiTenancy.setTenantIdCookie=function(e){e?t.utils.setCookieValue(t.multiTenancy.tenantIdCookieName,e.toString(),new Date((new Date).getTime()+15768e7),t.appPath,t.domain):t.utils.deleteCookie(t.multiTenancy.tenantIdCookieName,t.appPath)},t.multiTenancy.getTenantIdCookie=function(){var e=t.utils.getCookieValue(t.multiTenancy.tenantIdCookieName);return e?parseInt(e):null},t.session=t.session||{multiTenancySide:t.multiTenancy.sides.HOST},t.localization=t.localization||{},t.localization.languages=[],t.localization.currentLanguage={},t.localization.sources=[],t.localization.values={},t.localization.localize=function(e,n){n=n||t.localization.defaultSourceName;var o=t.localization.values[n];if(!o)return t.log.warn("Could not find localization source: "+n),e;var i=o[e];if(null==i)return e;var a=Array.prototype.slice.call(arguments,0);return a.splice(1,1),a[0]=i,t.utils.formatString.apply(this,a)},t.localization.getSource=function(e){return function(n){var o=Array.prototype.slice.call(arguments,0);return o.splice(1,0,e),t.localization.localize.apply(this,o)}},t.localization.isCurrentCulture=function(e){return t.localization.currentCulture&&t.localization.currentCulture.name&&0==t.localization.currentCulture.name.indexOf(e)},t.localization.defaultSourceName=void 0,t.localization.abpWeb=t.localization.getSource("AbpWeb"),t.auth=t.auth||{},t.auth.allPermissions=t.auth.allPermissions||{},t.auth.grantedPermissions=t.auth.grantedPermissions||{},t.auth.hasPermission=function(e){return t.auth.isGranted.apply(this,arguments)},t.auth.hasAnyOfPermissions=function(){return t.auth.isAnyGranted.apply(this,arguments)},t.auth.hasAllOfPermissions=function(){return t.auth.areAllGranted.apply(this,arguments)},t.auth.isGranted=function(e){return null!=t.auth.allPermissions[e]&&null!=t.auth.grantedPermissions[e]},t.auth.isAnyGranted=function(){if(!arguments||arguments.length<=0)return!0;for(var e=0;e<arguments.length;e++)if(t.auth.isGranted(arguments[e]))return!0;return!1},t.auth.areAllGranted=function(){if(!arguments||arguments.length<=0)return!0;for(var e=0;e<arguments.length;e++)if(!t.auth.isGranted(arguments[e]))return!1;return!0},t.auth.tokenCookieName="Abp.AuthToken",t.auth.setToken=function(e,n){t.utils.setCookieValue(t.auth.tokenCookieName,e,n,t.appPath,t.domain)},t.auth.getToken=function(){return t.utils.getCookieValue(t.auth.tokenCookieName)},t.auth.clearToken=function(){t.auth.setToken()},t.auth.refreshTokenCookieName="Abp.AuthRefreshToken",t.auth.setRefreshToken=function(e,n){t.utils.setCookieValue(t.auth.refreshTokenCookieName,e,n,t.appPath,t.domain)},t.auth.getRefreshToken=function(){return t.utils.getCookieValue(t.auth.refreshTokenCookieName)},t.auth.clearRefreshToken=function(){t.auth.setRefreshToken()},t.features=t.features||{},t.features.allFeatures=t.features.allFeatures||{},t.features.get=function(e){return t.features.allFeatures[e]},t.features.getValue=function(e){var n=t.features.get(e);if(null!=n)return n.value},t.features.isEnabled=function(e){var n=t.features.getValue(e);return"true"==n||"True"==n},t.setting=t.setting||{},t.setting.values=t.setting.values||{},t.setting.get=function(e){return t.setting.values[e]},t.setting.getBoolean=function(e){var n=t.setting.get(e);return"true"==n||"True"==n},t.setting.getInt=function(e){return parseInt(t.setting.values[e])},t.notifications=t.notifications||{},t.notifications.severity={INFO:0,SUCCESS:1,WARN:2,ERROR:3,FATAL:4},t.notifications.userNotificationState={UNREAD:0,READ:1},t.notifications.getUserNotificationStateAsString=function(e){switch(e){case t.notifications.userNotificationState.READ:return"READ";case t.notifications.userNotificationState.UNREAD:return"UNREAD";default:return t.log.warn("Unknown user notification state value: "+e),"?"}},t.notifications.getUiNotifyFuncBySeverity=function(e){switch(e){case t.notifications.severity.SUCCESS:return t.notify.success;case t.notifications.severity.WARN:return t.notify.warn;case t.notifications.severity.ERROR:case t.notifications.severity.FATAL:return t.notify.error;case t.notifications.severity.INFO:default:return t.notify.info}},t.notifications.messageFormatters={},t.notifications.messageFormatters["Abp.Notifications.MessageNotificationData"]=function(e){return e.notification.data.message||e.notification.data.properties.Message},t.notifications.messageFormatters["Abp.Notifications.LocalizableMessageNotificationData"]=function(n){var o=n.notification.data.message||n.notification.data.properties.Message,i=t.localization.localize(o.name,o.sourceName);if(n.notification.data.properties)if(e)e.each(n.notification.data.properties,function(e,t){i=i.replace("{"+e+"}",t)});else for(var a=Object.keys(n.notification.data.properties),r=0;r<a.length;r++)i=i.replace("{"+a[r]+"}",n.notification.data.properties[a[r]]);return i},t.notifications.getFormattedMessageFromUserNotification=function(e){var n=t.notifications.messageFormatters[e.notification.data.type];return n?t.utils.isFunction(n)?n(e):(t.log.warn("Message formatter should be a function! It is invalid for data type: "+e.notification.data.type),"?"):(t.log.warn("No message formatter defined for given data type: "+e.notification.data.type),"?")},t.notifications.showUiNotifyForUserNotification=function(e,n){var o=t.notifications.getFormattedMessageFromUserNotification(e);t.notifications.getUiNotifyFuncBySeverity(e.notification.severity)(o,void 0,n)},t.log=t.log||{},t.log.levels={DEBUG:1,INFO:2,WARN:3,ERROR:4,FATAL:5},t.log.level=t.log.levels.DEBUG,t.log.log=function(e,n){window.console&&window.console.log&&(null!=n&&n<t.log.level||console.log(e))},t.log.debug=function(e){t.log.log("DEBUG: ",t.log.levels.DEBUG),t.log.log(e,t.log.levels.DEBUG)},t.log.info=function(e){t.log.log("INFO: ",t.log.levels.INFO),t.log.log(e,t.log.levels.INFO)},t.log.warn=function(e){t.log.log("WARN: ",t.log.levels.WARN),t.log.log(e,t.log.levels.WARN)},t.log.error=function(e){t.log.log("ERROR: ",t.log.levels.ERROR),t.log.log(e,t.log.levels.ERROR)},t.log.fatal=function(e){t.log.log("FATAL: ",t.log.levels.FATAL),t.log.log(e,t.log.levels.FATAL)},t.notify=t.notify||{},t.notify.success=function(e,n,o){t.log.warn("abp.notify.success is not implemented!")},t.notify.info=function(e,n,o){t.log.warn("abp.notify.info is not implemented!")},t.notify.warn=function(e,n,o){t.log.warn("abp.notify.warn is not implemented!")},t.notify.error=function(e,n,o){t.log.warn("abp.notify.error is not implemented!")},t.message=t.message||{};var n,o,i,a=function(n,o,i){return alert((o||"")+" "+n),e?e.Deferred(function(e){e.resolve()}):(t.log.warn("abp.message can not return promise since jQuery is not defined!"),null)};return t.message.info=function(e,n,o){return t.log.warn("abp.message.info is not implemented!"),a(e,n)},t.message.success=function(e,n,o){return t.log.warn("abp.message.success is not implemented!"),a(e,n)},t.message.warn=function(e,n,o){return t.log.warn("abp.message.warn is not implemented!"),a(e,n)},t.message.error=function(e,n,o){return t.log.warn("abp.message.error is not implemented!"),a(e,n)},t.message.confirm=function(n,o,i,a){t.log.warn("abp.message.confirm is not implemented!");var r=confirm(n);return i&&i(r),e?e.Deferred(function(e){e.resolve()}):(t.log.warn("abp.message can not return promise since jQuery is not defined!"),null)},t.ui=t.ui||{},t.ui.block=function(e){t.log.warn("abp.ui.block is not implemented!")},t.ui.unblock=function(e){t.log.warn("abp.ui.unblock is not implemented!")},t.ui.setBusy=function(e,n){t.log.warn("abp.ui.setBusy is not implemented!")},t.ui.clearBusy=function(e){t.log.warn("abp.ui.clearBusy is not implemented!")},t.event=(n={},{on:function(e,t){n[e]||(n[e]=[]),n[e].push(t)},off:function(e,t){var o=n[e];if(o){for(var i=-1,a=0;a<o.length;a++)if(o[a]===t){i=a;break}i<0||n[e].splice(i,1)}},trigger:function(e){var t=n[e];if(t&&t.length)for(var o=Array.prototype.slice.call(arguments,1),i=0;i<t.length;i++)t[i].apply(this,o)}}),t.utils=t.utils||{},t.utils.createNamespace=function(e,t){for(var n=t.split("."),o=0;o<n.length;o++)void 0===e[n[o]]&&(e[n[o]]={}),e=e[n[o]];return e},t.utils.replaceAll=function(e,t,n){var o=t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return e.replace(new RegExp(o,"g"),n)},t.utils.formatString=function(){if(arguments.length<1)return null;for(var e=arguments[0],n=1;n<arguments.length;n++){var o="{"+(n-1)+"}";e=t.utils.replaceAll(e,o,arguments[n])}return e},t.utils.toPascalCase=function(e){return e&&e.length?1===e.length?e.charAt(0).toUpperCase():e.charAt(0).toUpperCase()+e.substr(1):e},t.utils.toCamelCase=function(e){return e&&e.length?1===e.length?e.charAt(0).toLowerCase():e.charAt(0).toLowerCase()+e.substr(1):e},t.utils.truncateString=function(e,t){return!e||!e.length||e.length<=t?e:e.substr(0,t)},t.utils.truncateStringWithPostfix=function(e,t,n){return n=n||"...",!e||!e.length||e.length<=t?e:t<=n.length?n.substr(0,t):e.substr(0,t-n.length)+n},t.utils.isFunction=function(t){return e?e.isFunction(t):!!(t&&t.constructor&&t.call&&t.apply)},t.utils.buildQueryString=function(e,t){void 0===t&&(t=!0);var n="";function o(){n.length?n+="&":t&&(n+="?")}for(var i=0;i<e.length;++i){var a=e[i];if(void 0!==a.value)if(null===a.value&&(a.value=""),o(),a.value.toJSON&&"function"==typeof a.value.toJSON)n=n+a.name+"="+encodeURIComponent(a.value.toJSON());else if(Array.isArray(a.value)&&a.value.length)for(var r=0;r<a.value.length;r++)r>0&&o(),n=n+a.name+"["+r+"]="+encodeURIComponent(a.value[r]);else n=n+a.name+"="+encodeURIComponent(a.value)}return n},t.utils.setCookieValue=function(e,t,n,o,i){var a=encodeURIComponent(e)+"=";t&&(a+=encodeURIComponent(t)),n&&(a=a+"; expires="+n.toUTCString()),o&&(a=a+"; path="+o),i&&(a=a+"; domain="+i),document.cookie=a},t.utils.getCookieValue=function(e){for(var t=document.cookie.split("; "),n=0;n<t.length;n++)if(t[n]){var o=t[n].split("=");if(2==o.length&&decodeURIComponent(o[0])===e)return decodeURIComponent(o[1]||"")}return null},t.utils.deleteCookie=function(e,t){var n=encodeURIComponent(e)+"=";n=n+"; expires="+new Date((new Date).getTime()-864e5).toUTCString(),t&&(n=n+"; path="+t),document.cookie=n},t.utils.getDomain=function(e){var t=/(https?:){0,1}\/\/((?:[\w\d-]+\.)+[\w\d]{2,})/i.exec(e);return t&&t[2]?t[2]:""},t.timing=t.timing||{},t.timing.utcClockProvider=(o=function(e){return Date.UTC(e.getUTCFullYear(),e.getUTCMonth(),e.getUTCDate(),e.getUTCHours(),e.getUTCMinutes(),e.getUTCSeconds(),e.getUTCMilliseconds())},{now:function(){return o(new Date)},normalize:function(e){return e?new Date(o(e)):e},supportsMultipleTimezone:!0}),t.timing.localClockProvider=(i=function(e){return new Date(e.getFullYear(),e.getMonth(),e.getDate(),e.getHours(),e.getMinutes(),e.getSeconds(),e.getMilliseconds())},{now:function(){return i(new Date)},normalize:function(e){return e?i(e):e},supportsMultipleTimezone:!1}),t.timing.unspecifiedClockProvider={now:function(){return new Date},normalize:function(e){return e},supportsMultipleTimezone:!1},t.timing.convertToUserTimezone=function(e){var n=e.getTime()+6e4*e.getTimezoneOffset(),o=parseInt(n)+parseInt(t.timing.timeZoneInfo.windows.currentUtcOffsetInMilliseconds);return new Date(o)},t.clock=t.clock||{},t.clock.now=function(){return t.clock.provider?t.clock.provider.now():new Date},t.clock.normalize=function(e){return t.clock.provider?t.clock.provider.normalize(e):e},t.clock.provider=t.timing.unspecifiedClockProvider,t.security=t.security||{},t.security.antiForgery=t.security.antiForgery||{},t.security.antiForgery.tokenCookieName="XSRF-TOKEN",t.security.antiForgery.tokenHeaderName="X-XSRF-TOKEN",t.security.antiForgery.getToken=function(){return t.utils.getCookieValue(t.security.antiForgery.tokenCookieName)},t.security.antiForgery.shouldSendToken=function(e){return void 0===e.crossDomain||null===e.crossDomain?t.utils.getDomain(location.href)===t.utils.getDomain(e.url):!e.crossDomain},t}()})}("function"==typeof define&&define.amd?define:function(e,t){"undefined"!=typeof module&&module.exports?module.exports=t(require("jquery")):window.abp=t(window.jQuery)});
!function(e){e(["jquery","abp-web-resources"],function(e,r){return function(){if(e&&r)return r.ajax=function(a){a=a||{};var o=e.extend(!0,{},r.ajax.defaultOpts,a),t=o.beforeSend;return o.beforeSend=function(e,r){t&&t(e,r),e.setRequestHeader("Pragma","no-cache"),e.setRequestHeader("Cache-Control","no-cache"),e.setRequestHeader("Expires","Sat, 01 Jan 2000 00:00:00 GMT")},o.success=void 0,o.error=void 0,e.Deferred(function(t){e.ajax(o).done(function(e,o,s){e.__abp?r.ajax.handleResponse(e,a,t,s):(t.resolve(e),a.success&&a.success(e))}).fail(function(e){e.responseJSON&&e.responseJSON.__abp?r.ajax.handleResponse(e.responseJSON,a,t,e):r.ajax.handleNonAbpErrorResponse(e,a,t)})})},e.extend(r.ajax,{defaultOpts:{dataType:"json",type:"POST",contentType:"application/json",headers:{"X-Requested-With":"XMLHttpRequest"}},defaultError:{message:"An error has occurred!",details:"Error detail not sent by server."},defaultError401:{message:"You are not authenticated!",details:"You should be authenticated (sign in) in order to perform this operation."},defaultError403:{message:"You are not authorized!",details:"You are not allowed to perform this operation."},defaultError404:{message:"Resource not found!",details:"The resource requested could not found on the server."},logError:function(e){r.log.error(e)},showError:function(e){return e.details?r.message.error(e.details,e.message):r.message.error(e.message||r.ajax.defaultError.message)},handleTargetUrl:function(e){location.href=e||r.appPath},handleNonAbpErrorResponse:function(e,a,o){if(!1!==a.abpHandleError)switch(e.status){case 401:r.ajax.handleUnAuthorizedRequest(r.ajax.showError(r.ajax.defaultError401),r.appPath);break;case 403:r.ajax.showError(r.ajax.defaultError403);break;case 404:r.ajax.showError(r.ajax.defaultError404);break;default:r.ajax.showError(r.ajax.defaultError)}o.reject.apply(this,arguments),a.error&&a.error.apply(this,arguments)},handleUnAuthorizedRequest:function(e,a){e?e.done(function(){r.ajax.handleTargetUrl(a)}):r.ajax.handleTargetUrl(a)},handleResponse:function(e,a,o,t){if(e)if(!0===e.success)o&&o.resolve(e.result,e,t),a.success&&a.success(e.result,e,t),e.targetUrl&&r.ajax.handleTargetUrl(e.targetUrl);else if(!1===e.success){var s=null;e.error?!1!==a.abpHandleError&&(s=r.ajax.showError(e.error)):e.error=r.ajax.defaultError,r.ajax.logError(e.error),o&&o.reject(e.error,t),a.error&&a.error(e.error,t),401===t.status&&!1!==a.abpHandleError&&r.ajax.handleUnAuthorizedRequest(s,e.targetUrl)}else o&&o.resolve(e,null,t),a.success&&a.success(e,null,t);else o&&o.resolve(t),a.success&&a.success(t)},blockUI:function(e){e.blockUI&&(!0===e.blockUI?r.ui.setBusy():r.ui.setBusy(e.blockUI))},unblockUI:function(e){e.blockUI&&(!0===e.blockUI?r.ui.clearBusy():r.ui.clearBusy(e.blockUI))},ajaxSendHandler:function(e,a,o){var t=r.security.antiForgery.getToken();t&&r.security.antiForgery.shouldSendToken(o)&&(o.headers&&void 0!==o.headers[r.security.antiForgery.tokenHeaderName]||a.setRequestHeader(r.security.antiForgery.tokenHeaderName,t))}}),e(document).ajaxSend(function(e,a,o){return r.ajax.ajaxSendHandler(e,a,o)}),e.fn.ajaxForm&&(e.fn.abpAjaxForm=function(a){a=a||{};var o=e.extend({},e.fn.abpAjaxForm.defaults,a);return o.beforeSubmit=function(){r.ajax.blockUI(o),a.beforeSubmit&&a.beforeSubmit.apply(this,arguments)},o.success=function(e){r.ajax.handleResponse(e,a)},o.complete=function(){r.ajax.unblockUI(o),a.complete&&a.complete.apply(this,arguments)},this.ajaxForm(o)},e.fn.abpAjaxForm.defaults={method:"POST"}),r.event.on("abp.dynamicScriptsInitialized",function(){r.ajax.defaultError.message=r.localization.abpWeb("DefaultError"),r.ajax.defaultError.details=r.localization.abpWeb("DefaultErrorDetail"),r.ajax.defaultError401.message=r.localization.abpWeb("DefaultError401"),r.ajax.defaultError401.details=r.localization.abpWeb("DefaultErrorDetail401"),r.ajax.defaultError403.message=r.localization.abpWeb("DefaultError403"),r.ajax.defaultError403.details=r.localization.abpWeb("DefaultErrorDetail403"),r.ajax.defaultError404.message=r.localization.abpWeb("DefaultError404"),r.ajax.defaultError404.details=r.localization.abpWeb("DefaultErrorDetail404")}),r}()})}("function"==typeof define&&define.amd?define:function(e,r){"undefined"!=typeof module&&module.exports?module.exports=r(require("jquery"),require("abp-web-resources")):window.abp=r(window.jQuery,window.abp)});
!function(n){n(["toastr","abp-web-resources"],function(n,o){return function(){if(n&&o){n.options.positionClass="toast-bottom-right";var t=function(o,t,e,i){n[o](t,e,i)};return o.notify.success=function(n,o,e){t("success",n,o,e)},o.notify.info=function(n,o,e){t("info",n,o,e)},o.notify.warn=function(n,o,e){t("warning",n,o,e)},o.notify.error=function(n,o,e){t("error",n,o,e)},o}}()})}("function"==typeof define&&define.amd?define:function(n,o){"undefined"!=typeof module&&module.exports?module.exports=o(require("toastr"),require("abp-web-resources")):window.abp=o(window.toastr,window.abp)});
var abp=abp||{};$.blockUI&&($.extend($.blockUI.defaults,{message:" ",css:{},overlayCSS:{backgroundColor:"#AAA",opacity:.3,cursor:"wait"}}),abp.ui.block=function(o){o?$(o).block():$.blockUI()},abp.ui.unblock=function(o){o?$(o).unblock():$.unblockUI()});
var abp=abp||{};$.fn.spin&&(abp.libs=abp.libs||{},abp.libs.spinjs={spinner_config:{lines:11,length:0,width:10,radius:20,corners:1,trail:60,speed:1.2},spinner_config_inner_busy_indicator:{lines:11,length:0,width:4,radius:7,corners:1,trail:60,speed:1.2}},abp.ui.setBusy=function(i,n){((n=n||{}).always||n.finally)&&(n={promise:n});var s=$.extend({},n);if(i){var a=$(i),p=a.find(".abp-busy-indicator");p.length?p.spin(abp.libs.spinjs.spinner_config_inner_busy_indicator):(0!=s.blockUI&&abp.ui.block(i),a.spin(abp.libs.spinjs.spinner_config))}else 0!=s.blockUI&&abp.ui.block(),$("body").spin(abp.libs.spinjs.spinner_config);s.promise&&(s.promise.always?s.promise.always(function(){abp.ui.clearBusy(i)}):s.promise.finally&&s.promise.finally(function(){abp.ui.clearBusy(i)}))},abp.ui.clearBusy=function(i){if(i){var n=$(i),s=n.find(".abp-busy-indicator");s.length?s.spin(!1):(abp.ui.unblock(i),n.spin(!1))}else abp.ui.unblock(),$("body").spin(!1)});
var abp=abp||{};!function(e){if(sweetAlert&&e){abp.libs=abp.libs||{},abp.libs.sweetAlert={config:{default:{},info:{icon:"info"},success:{icon:"success"},warn:{icon:"warning"},error:{icon:"error"},confirm:{icon:"warning",title:"Are you sure?",buttons:["Cancel","Yes"]}}};var n=function(n,t,i,r,a){a=a||{};var o={};if(i&&(o.title=i),a.isHtml){delete a.isHtml;var s=document.createElement("div");s.style="position: relative;",s.innerHTML=t,o.content=s}else o.text=t;var l=e.extend({},abp.libs.sweetAlert.config.default,abp.libs.sweetAlert.config[n],o,a);return e.Deferred(function(e){sweetAlert(l).then(function(n){r&&r(n),e.resolve(n)})})};abp.message.info=function(e,t,i){return n("info",e,t,null,i)},abp.message.success=function(e,t,i){return n("success",e,t,null,i)},abp.message.warn=function(e,t,i){return n("warn",e,t,null,i)},abp.message.error=function(e,t,i){return n("error",e,t,null,i)},abp.message.confirm=function(e,t,i,r){return n("confirm",e,t,i,r)},abp.event.on("abp.dynamicScriptsInitialized",function(){abp.libs.sweetAlert.config.confirm.title=abp.localization.abpWeb("AreYouSure"),abp.libs.sweetAlert.config.confirm.buttons=[abp.localization.abpWeb("Cancel"),abp.localization.abpWeb("Yes")]})}}(jQuery);