...
"use strict";var KTLayoutAsideMenu=function(){var e,n;return{init:function(o){(e=KTUtil.getById(o))&&(n=new KTMenu(e,{submenu:{desktop:"accordion",tablet:"accordion",mobile:"accordion"},accordion:{expandAll:!1}})).on("linkClick",function(e){KTUtil.isBreakpointDown("lg")&&KTLayoutAside.getOffcanvas().hide()})},getElement:function(){return e},getMenu:function(){return n},pauseDropdownHover:function(e){n&&n.pauseDropdownHover(e)},closeMobileOffcanvas:function(){n&&KTUtil.isMobileDevice()&&n.hide()}}}();"undefined"!=typeof module&&(module.exports=KTLayoutAsideMenu);
"use strict";var KTLayoutAsideToggle=function(){var e,t,o;return{init:function(n){t=KTUtil.getById(n),e=KTUtil.getBody(),t&&((o=new KTToggle(t,e,{targetState:"aside-minimize",toggleState:"aside-toggle-active"})).on("toggle",function(e){"undefined"!=typeof KTLayoutStickyCard&&setTimeout(function(){KTLayoutStickyCard.update()},500),"undefined"!=typeof KTLayoutHeaderMenu&&KTLayoutHeaderMenu.pauseDropdownHover(800),"undefined"!=typeof KTLayoutAsideMenu&&KTLayoutAsideMenu.pauseDropdownHover(800),KTCookie.setCookie("kt_aside_toggle_state",e.getState())}),o.on("beforeToggle",function(e){}))},getElement:function(){return t},getToggle:function(){return o},onToggle:function(e){void 0!==o.element&&o.on("toggle",e)}}}();"undefined"!=typeof module&&(module.exports=KTLayoutAsideToggle);
"use strict";var KTLayoutAside=function(){var t,e;return{init:function(i){var a,s,n,r;(t=KTUtil.getById(i),KTUtil.getBody(),t)&&(a=KTUtil.hasClass(t,"aside-offcanvas-default")?"aside-offcanvas-default":"aside",e=new KTOffcanvas(t,{baseClass:a,overlay:!0,closeBy:"kt_aside_close_btn",toggleBy:{target:"kt_aside_mobile_toggle",state:"mobile-toggle-active"}}),(s=KTUtil.find(t,".aside-primary .aside-nav"))&&KTUtil.scrollInit(s,{disableForMobile:!0,resetHeightOnDestroy:!0,handleWindowResize:!0,height:function(){var e=parseInt(KTUtil.getViewPort().height),i=KTUtil.find(t,".aside-primary .aside-brand"),a=KTUtil.find(t,".aside-primary .aside-footer");return e-=parseInt(KTUtil.css(i,"height")),e-=parseInt(KTUtil.css(i,"marginBottom"))+parseInt(KTUtil.css(i,"marginTop")),e-=parseInt(KTUtil.css(a,"height")),e-=parseInt(KTUtil.css(a,"marginBottom"))+parseInt(KTUtil.css(a,"marginTop"))}}),n=KTUtil.find(t,".aside-primary .aside-nav .nav"),(r=KTUtil.find(t,".aside-secondary .aside-workspace"))&&(KTUtil.scrollInit(r,{disableForMobile:!0,resetHeightOnDestroy:!0,handleWindowResize:!0,height:function(){var e=parseInt(KTUtil.getViewPort().height),i=KTUtil.find(t,".aside-secondary");return e-=parseInt(KTUtil.css(r,"marginBottom"))+parseInt(KTUtil.css(r,"marginTop")),e-=parseInt(KTUtil.css(i,"paddingBottom"))+parseInt(KTUtil.css(i,"paddingTop"))}}),n&&$(n).find('a[data-toggle="tab"]').on("shown.bs.tab",function(t){KTUtil.scrollUpdate(r)})))},getElement:function(){return t},getOffcanvas:function(){return e}}}();"undefined"!=typeof module&&(module.exports=KTLayoutAside);
"use strict";var KTLayoutContent=function(){var t;return{init:function(e){t=KTUtil.getById(e)},getHeight:function(){return e=KTUtil.getViewPort().height,t&&(e=e-parseInt(KTUtil.css(t,"paddingTop"))-parseInt(KTUtil.css(t,"paddingBottom"))),e-=KTLayoutSubheader.getHeight(),e-=KTLayoutFooter.getHeight();var e},getElement:function(){return t}}}();"undefined"!=typeof module&&(module.exports=KTLayoutContent);
...
"use strict";var KTLayoutHeaderMobile=function(){var e;return{init:function(t){e=KTUtil.getById(t)},isFixed:function(){return KTUtil.hasClass(KTUtil.getBody(),"header-mobile-fixed")},getElement:function(){return e},getHeader:function(){},getHeight:function(){return KTUtil.actualHeight(e)}}}();"undefined"!=typeof module&&(module.exports=KTLayoutHeaderMobile);
