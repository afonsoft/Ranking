...
"use strict";var KTLayoutHeaderMenu=function(){var e,n,t,o;return{init:function(a,r){e=KTUtil.getById(a),t=KTUtil.getById(r),e&&(o=new KTOffcanvas(t,{overlay:!0,baseClass:"header-menu-wrapper",closeBy:"kt_header_menu_mobile_close_btn",toggleBy:{target:"kt_header_mobile_toggle",state:"mobile-toggle-active"}}),n=new KTMenu(e,{submenu:{desktop:"dropdown",tablet:"accordion",mobile:"accordion"},accordion:{slideSpeed:200,expandAll:!1}}))},getMenuElement:function(){return e},getOffcanvasElement:function(){return t},getMenu:function(){return n},pauseDropdownHover:function(e){n&&n.pauseDropdownHover(e)},getOffcanvas:function(){return o},closeMobileOffcanvas:function(){n&&KTUtil.isMobileDevice()&&o.hide()}}}();"undefined"!=typeof module&&(module.exports=KTLayoutHeaderMenu);
"use strict";var KTLayoutHeaderTopbar=function(){var t;return{init:function(e){(t=KTUtil.getById(e))&&new KTToggle(t,KTUtil.getBody(),{targetState:"topbar-mobile-on",toggleState:"topbar-toggle-active"})},getToggleElement:function(){return t}}}();"undefined"!=typeof module&&(module.exports=KTLayoutHeaderTopbar);
...
"use strict";var KTLayoutSidebar=function(){var t;return{init:function(e){var i,n;(t=KTUtil.getById(e))&&(i=KTUtil.find(t,".sidebar-header"),n=KTUtil.find(t,".sidebar-content"),new KTOffcanvas(t,{overlay:!0,baseClass:"sidebar",placement:"right",closeBy:"kt_sidebar_mobile_close",toggleBy:"kt_sidebar_mobile_toggle"}),KTUtil.scrollInit(n,{disableForMobile:!0,resetHeightOnDestroy:!0,handleWindowResize:!0,height:function(){if(KTUtil.isBreakpointUp("lg"))return!1;var e=parseInt(KTUtil.getViewPort().height);return i&&(e-=parseInt(KTUtil.actualHeight(i)),e-=parseInt(KTUtil.css(i,"marginTop")),e-=parseInt(KTUtil.css(i,"marginBottom"))),n&&(e-=parseInt(KTUtil.css(n,"marginTop")),e-=parseInt(KTUtil.css(n,"marginBottom"))),e-=parseInt(KTUtil.css(t,"paddingTop")),e-=parseInt(KTUtil.css(t,"paddingBottom")),e-=parseInt(KTUtil.css(t,"marginTop")),e-=parseInt(KTUtil.css(t,"marginBottom")),e-=2}}))},getElement:function(){return t}}}();"undefined"!=typeof module&&(module.exports=KTLayoutSidebar);
