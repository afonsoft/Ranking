            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (severity, type, row, meta) {
                        ...
                        var $span = $('<span></span>');
                        var $icon = $(`<i class="${icon} ${iconFontClass} fa-2x" data-toggle="tooltip" data-placement="right" data-container="body" data-original-title="${getNotificationTextBySeverity(row.notification.severity)}"></i>`);
                        $span
                            .append($icon);                        
