...
namespace Afonsoft.Ranking.Web.Areas.App.Views.Shared.Themes.Default.Components.AppDefaultBrand
{
    public class AppDefaultBrandViewComponent : RankingViewComponent
    {
