...
using Afonsoft.Ranking.Web.Areas.App.Models.Languages;
...
namespace Afonsoft.Ranking.Web.Areas.App.Controllers
{
    ...
    public class LanguagesController : RankingControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = RankingConsts.LocalizationSourceName;
            }
