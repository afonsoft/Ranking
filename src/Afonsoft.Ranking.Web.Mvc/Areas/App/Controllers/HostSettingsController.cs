...
using Afonsoft.Ranking.Configuration.Host;
using Afonsoft.Ranking.Editions;
using Afonsoft.Ranking.Timing;
using Afonsoft.Ranking.Timing.Dto;
using Afonsoft.Ranking.Web.Areas.App.Models.HostSettings;
...
namespace Afonsoft.Ranking.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : RankingControllerBase
    {
