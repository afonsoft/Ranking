...
using Afonsoft.Ranking.Authorization.Users.Profile;
using Afonsoft.Ranking.Configuration;
using Afonsoft.Ranking.Timing;
using Afonsoft.Ranking.Timing.Dto;
using Afonsoft.Ranking.Web.Areas.App.Models.Profile;
...
namespace Afonsoft.Ranking.Web.Areas.App.Controllers
{
    [Area("App")]
    [AbpMvcAuthorize]
    public class ProfileController : RankingControllerBase
    {
