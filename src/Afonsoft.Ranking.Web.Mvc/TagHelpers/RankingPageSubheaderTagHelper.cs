...
using Afonsoft.Ranking.UiCustomization.Dto;

namespace Afonsoft.Ranking.Web.TagHelpers
{
    ...
    public class RankingPageSubheaderTagHelper : TagHelper
    {
        ...
        public RankingPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
