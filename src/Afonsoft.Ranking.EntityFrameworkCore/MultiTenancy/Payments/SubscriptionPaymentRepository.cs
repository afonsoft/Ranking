...
{
    public class SubscriptionPaymentRepository : RankingRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<RankingDbContext> dbContextProvider)
