...
namespace Afonsoft.Ranking.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : RankingAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<RankingDbContext> _migrator;
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{RankingConsts.ConnectionStringName}", constring);
        }
