...
using Afonsoft.Ranking.Auditing.Exporting;
...
using EntityHistoryHelper = Afonsoft.Ranking.EntityHistory.EntityHistoryHelper;

namespace Afonsoft.Ranking.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : RankingAppServiceBase, IAuditLogAppService
    {
