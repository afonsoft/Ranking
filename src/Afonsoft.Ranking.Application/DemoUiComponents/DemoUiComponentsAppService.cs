...
using Afonsoft.Ranking.DemoUiComponents.Dto;

namespace Afonsoft.Ranking.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : RankingAppServiceBase, IDemoUiComponentsAppService
    {
