...
{
    public class SessionAppService : RankingAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = RankingConsts.Currency,
                    CurrencySign = RankingConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = RankingConsts.AllowTenantsToChangeEmailSettings,
