...
using Abp.UI;
using Afonsoft.Ranking.Notifications.Dto;

namespace Afonsoft.Ranking.Notifications
{
    [AbpAuthorize]
    public class NotificationAppService : RankingAppServiceBase, INotificationAppService
    {
