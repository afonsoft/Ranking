...
namespace Afonsoft.Ranking.Web.Authentication.JwtBearer
{
    public class RankingJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public RankingJwtSecurityTokenHandler()
        {
