...
{
    public class StripeGatewayManager : RankingServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Ranking";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + RankingConsts.Currency;
        }
