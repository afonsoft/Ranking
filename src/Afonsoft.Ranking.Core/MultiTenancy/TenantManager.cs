...
using Afonsoft.Ranking.MultiTenancy.Demo;
...
namespace Afonsoft.Ranking.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(RankingConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(RankingConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
