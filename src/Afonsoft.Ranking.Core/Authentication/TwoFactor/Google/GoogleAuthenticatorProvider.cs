...
namespace Afonsoft.Ranking.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : RankingServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Afonsoft.Ranking", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
