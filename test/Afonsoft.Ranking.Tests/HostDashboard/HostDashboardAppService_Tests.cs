...
using Afonsoft.Ranking.MultiTenancy.HostDashboard;
...
namespace Afonsoft.Ranking.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(RankingDbContext context, SubscriptionPayment subscriptionPayment)
        {
