...
$webMvcFolder = Join-Path $slnFolder "src/Afonsoft.Ranking.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/Afonsoft.Ranking.Web.Public"
...
dotnet restore Afonsoft.Ranking.Web.sln
